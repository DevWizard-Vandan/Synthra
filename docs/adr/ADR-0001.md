...
1.  All system interfaces, data schemas, and agent communication patterns must be fully documented in design specifications or Architecture Decision Records (ADRs) before any implementation begins.
2.  Any modification of core modules, database integrations, or runtime execution parameters requires an updated ADR entry for review and approval.
